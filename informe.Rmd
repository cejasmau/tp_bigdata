...
para el procesamiento eficiente y escalable de información. Tecnologías como Apache Spark y Kafka se han convertido
...
liviana, desplegando un clúster compuesto por cinco nodos que integran Apache Spark (Master y dos Workers), Apache Kafka y Apache Zookeeper. 
...
Kafka como sistema de mensajería distribuido. El repositorio completo del proyecto se encuentra disponible en el enlace: 
<https://github.com/cejasmau/tp_bigdata>
